...
contract LiquidityMiningTest is Test, Deployers, GasSnapshot {
    ...
    function test_SingleLp_LiquidityPoints() external {
    ...
    function test_TwoLP_LiquidityPoints_1() external {
    ...
    function test_TwoLP_LiqudityPoints_2() external {
        PositionRef memory p1 = addLiquidity(1e18, -1200, 1200, keccak256("1"));
        PositionRef memory p2 = addLiquidity(3e18, -1200, 1200, keccak256("2"));
    ...
    function test_TwoLP_Streams_1() external {
        PositionRef memory p1 = addLiquidity(1e18, -1200, 1200, keccak256("1"));
        PositionRef memory p2 = addLiquidity(3e18, -1200, 1200, keccak256("2"));
    ...
    function assertEqWithError(uint256 actual, uint256 expected, uint256 maxError, string memory m) internal pure {
