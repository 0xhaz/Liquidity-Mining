...
library LiquidityPoints {
    ...
    /// @notice Liquidity points are fractional seconds inside based on user vs global liquidity
    ...
    function computeSecondsX32(
        ...
        // TLDR: Fractional seconds inside the quantity is scaled up by a factor of 2^32 to preserve precision
        //
        // Bit Analysis
        ...
        // Liquidity points -> Secodns per global liquidity user times liquidity bits:
