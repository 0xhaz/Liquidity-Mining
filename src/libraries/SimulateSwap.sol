...
library Simulate {
    ...
    function swap(
        ...
        while (!(state.amountSpecifiedRemaining == 0 || state.sqrtPriceX96 == params.sqrtPriceLimitX96)) {
            ...
            // computes values to swap to the target tick, price limit, or point where input/output amount is exhausted
            ...
            // if the procotol fee is on, calculate how much is owed, decrement feeAmount, and increment protocolFee
            if (protocolFee > 0) {
                unchecked {
            ...
            if (state.sqrtPriceX96 == step.sqrtPriceNextX96) {
                ...
                if (step.initialized) {
                    ...
                    // safe because liquidityNet cannot be equal to type(int128).min
                    unchecked {
